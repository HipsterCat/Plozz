...
struct SubtitleStylePanel: View {
    ...
    private var styleMainRows: (rows: [StyleRowSpec], dividerBefore: Int) {
        ...
        rows.append(choiceRow(slot, "Extra Line Position", options: SubtitleStyle.VerticalAnchor.allCases, current: s.verticalAnchor, label: { $0.displayName }) { v in updateStyle { $0.verticalAnchor = v } }); slot += 1

...
public struct LiveTVPlaylistSource: Codable, Equatable, Identifiable, Sendable {
    ...
    private enum CodingKeys: String, CodingKey {
        case id, name, playlistURL, guideURLs, isEnabled
    }
    ...
    public func validate() throws {
        ...
        guard Self.isSupportedURL(playlistURL) else { throw LiveTVSourcesValidationError.invalidPlaylistURL }
        guard guideURLs.count <= 32, Set(guideURLs).count == guideURLs.count else {
